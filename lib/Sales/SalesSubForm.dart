...
class SalesSubForm extends StatefulWidget {
  @override
  _SalesSubFormState createState() => _SalesSubFormState();
}

class _SalesSubFormState extends State<SalesSubForm> {
            ...
            children: [
              ...
              if (tableData.isNotEmpty)
                ...tableData.map((data) {
                  ...
                  var dateno = data['finalamount'].toString();
