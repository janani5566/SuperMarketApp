...
class SalesCurrentWeekPage extends StatefulWidget {
  @override
  _SalesCurrentWeekPageState createState() => _SalesCurrentWeekPageState();
}

class _SalesCurrentWeekPageState extends State<SalesCurrentWeekPage> {
