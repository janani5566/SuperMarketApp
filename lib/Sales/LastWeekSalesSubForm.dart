...
class SalesPreviousWeekPage extends StatefulWidget {
  @override
  _SalesPreviousWeekPageState createState() => _SalesPreviousWeekPageState();
}

class _SalesPreviousWeekPageState extends State<SalesPreviousWeekPage> {
