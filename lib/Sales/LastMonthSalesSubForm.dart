...
class SalesLastMonthPage extends StatefulWidget {
  @override
  _SalesLastMonthPageState createState() => _SalesLastMonthPageState();
}

class _SalesLastMonthPageState extends State<SalesLastMonthPage> {
  ...
  Future<void> fetchData() async {
    ...
    String apiUrl = 'http://$ipAddress/LastMonthSales-Detail/';
    http.Response response = await http.get(Uri.parse(apiUrl));
    var jsonData = json.decode(response.body);

    if (jsonData['LastMonthSales_Detail'] != null) {
      var lastWeekSalesDetails = jsonData['LastMonthSales_Detail'] as List;
