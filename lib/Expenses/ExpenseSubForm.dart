...
class TodaySaleExpensePage extends StatefulWidget {
  @override
  _TodaySaleExpensePageState createState() => _TodaySaleExpensePageState();
}

class _TodaySaleExpensePageState extends State<TodaySaleExpensePage> {
  ...
  Future<void> fetchData() async {
    ...
    if (jsonData['Expense_TodayDetail'] != null) {
      var lastWeekSalesDetails = jsonData['Expense_TodayDetail'] as List;
